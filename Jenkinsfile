            ...
            script: [$class: 'GroovyScript',
                ...
                script: [
                    ...
                    script: """
                      ...
                      return inputBox = '''
                      <table id="broker">
                        <tr><td>kafka_container_name</td><td>=</td><td><input name='value' type='text' class=' ' placeholder="kafka1-1"></td></tr>
                        ...
                        <tr><td>port__monitoring</td><td>=</td><td><input name='value' type='list' class=' ' placeholder="9201"></td></tr>
